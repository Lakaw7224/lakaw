...
export const menuItems: MenuItem[] = [
  // ── coffee ─────────────────────────────────────────────
  {
    ...
    names: { zh: '美式', en: 'Americano', ja: 'アメリカーノ', ko: '아메리카노' },
  ...
  },
  {
    ...
    names: { zh: '拿鐵', en: 'Latte', ja: 'ラテ', ko: '라떼' },
  ...
  },
  {
    ...
    names: { zh: '美酒加咖啡', en: 'Americano + Sticky Rice Wine', ja: 'アメリカーノ＋もち米酒', ko: '아메리카노 + 찹쌀주' },
  ...
  // ── pour over ──────────────────────────────────────────
  {
    ...
    names: { zh: '秘魯 娜魯礄莊園', en: 'Peru — Naruchu Estate', ja: 'ペルー ナルチョ農園', ko: '페루 나루초 농원' },
  ...
  // ── herbal tea ─────────────────────────────────────────
  {
    ...
    names: { zh: '野香菜 Pipit', en: 'Pipit Wild Herb Tea', ja: 'ピピット 野香菜茶', ko: 'Pipit 야생 향채차' },
  ...
  },
  {
    ...
    names: { zh: '清炒菊花茶', en: 'Toasted Chrysanthemum Tea', ja: '炒り菊花茶', ko: '볶은 국화차' },
  ...
  },
  {
    ...
    names: { zh: '甜洛黎百香花茶', en: 'Sweet Roselle & Passion Flower Tea', ja: 'ローゼル＆パッションフラワー茶', ko: '로젤 & 패션플라워 차' },
    price: [{ label: null, value: 60 }],
    image: null, emoji: '🌺', tags: [],
    desc: { zh: '', en: '', ja: '', ko: '' },
    note: { zh: '', en: '', ja: '', ko: '' },
  },
  {
    ...
    names: { zh: '森林泡泡蜜', en: 'Forest Honey Bubble', ja: '森のはちみつバブル', ko: '숲의 꿀 버블' },
    price: [{ label: null, value: 60 }],
    image: null, emoji: '🍯', tags: [],
    desc: { zh: '', en: '', ja: '', ko: '' },
    note: { zh: '', en: '', ja: '', ko: '' },
